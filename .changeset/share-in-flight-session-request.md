...
Session responses are also applied in the order they were asked for rather than the order they arrive, so a refresh that started before a login or a logout no longer lands afterwards and puts the session it replaced back into the store.
