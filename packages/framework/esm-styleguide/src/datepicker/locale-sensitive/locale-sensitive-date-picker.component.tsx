...
interface LocaleSensitiveDatePickerProps {
  id: string;
  labelText: string;
...
export const LocaleSensitiveDatePicker: React.FC<
  LocaleSensitiveDatePickerProps
> = ({
  id,
  labelText,
  onChange,
...
export default LocaleSensitiveDatePicker;
