[@openmrs/esm-framework](API.md) / Exports
...
- [MaybeAsync](modules.md#maybeasync)
- [NavigationContextType](modules.md#navigationcontexttype)
...
- [extensionStore](modules.md#extensionstore)
...
- [age](modules.md#age)
- [attach](modules.md#attach)
- [checkStatus](modules.md#checkstatus)
- [checkStatusFor](modules.md#checkstatusfor)
...
- [detach](modules.md#detach)
- [detachAll](modules.md#detachall)
...
- [getAssignedIds](modules.md#getassignedids)
...
- [getCustomProps](modules.md#getcustomprops)
- [getExtensionConfigStore](modules.md#getextensionconfigstore)
- [getExtensionNameFromId](modules.md#getextensionnamefromid)
- [getExtensionRegistration](modules.md#getextensionregistration)
- [getExtensionRegistrationFrom](modules.md#getextensionregistrationfrom)
- [getExtensionSlotsConfigStore](modules.md#getextensionslotsconfigstore)
- [getExtensionSlotsForModule](modules.md#getextensionslotsformodule)
...
- [getUpdatedExtensionSlotInfo](modules.md#getupdatedextensionslotinfo)
...
- [pushNavigationContext](modules.md#pushnavigationcontext)
...
- [registerExtension](modules.md#registerextension)
- [registerExtensionSlot](modules.md#registerextensionslot)
- [registerOmrsServiceWorker](modules.md#registeromrsserviceworker)
- [renderExtension](modules.md#renderextension)
...
- [unregisterExtensionSlot](modules.md#unregisterextensionslot)
- [update](modules.md#update)
- [updateExtensionStore](modules.md#updateextensionstore)
...
A React link component which calls [navigate](modules.md#navigate) when clicked

**`param`** The target path or URL. Supports interpolation. See [navigate](modules.md#navigate)
...
[packages/framework/esm-offline/src/sync.ts:92](https://github.com/openmrs/openmrs-esm-core/blob/master/packages/framework/esm-offline/src/sync.ts#L92)
...
[packages/framework/esm-offline/src/sync.ts:78](https://github.com/openmrs/openmrs-esm-core/blob/master/packages/framework/esm-offline/src/sync.ts#L78)
...
[packages/framework/esm-offline/src/sync.ts:73](https://github.com/openmrs/openmrs-esm-core/blob/master/packages/framework/esm-offline/src/sync.ts#L73)
...
| Name | Type |
| :------ | :------ |
| `_type` | [NavigationContextType](modules.md#navigationcontexttype) |
| `link` | `string` |
| `_state?` | `T` |
...
[packages/framework/esm-offline/src/sync.ts:97](https://github.com/openmrs/openmrs-esm-core/blob/master/packages/framework/esm-offline/src/sync.ts#L97)
...
| Name | Type |
| :------ | :------ |
| `updater` | (`state`: [ExtensionStore](interfaces/extensionstore.md)) => [MaybeAsync](modules.md#maybeasync)<Pick<[ExtensionStore](interfaces/extensionstore.md), U\>\> |
...
▸ **useCurrentPatient**(`patientUuid?`): [`boolean`, `NullablePatient`, [PatientUuid](modules.md#patientuuid), `Error` \| ``null``]
...
[`boolean`, `NullablePatient`, [PatientUuid](modules.md#patientuuid), `Error` \| ``null``]
