...
Defined in: [packages/framework/esm-emr-api/src/visit-type.ts:29](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/visit-type.ts#L29)
