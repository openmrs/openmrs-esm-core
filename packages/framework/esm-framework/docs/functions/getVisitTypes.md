...
Defined in: [packages/framework/esm-emr-api/src/visit-type.ts:29](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/visit-type.ts#L29)
