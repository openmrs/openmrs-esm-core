...
Defined in: [packages/framework/esm-react-utils/src/useConnectivity.ts:22](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useConnectivity.ts#L22)
