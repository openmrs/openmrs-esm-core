...
Defined in: [packages/framework/esm-react-utils/src/useOnClickOutside.ts:31](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useOnClickOutside.ts#L31)
