...
Defined in: [packages/framework/esm-error-handling/src/index.ts:43](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-error-handling/src/index.ts#L43)
