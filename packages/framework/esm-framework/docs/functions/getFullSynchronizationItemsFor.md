...
Defined in: [packages/framework/esm-offline/src/sync.ts:281](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L281)
