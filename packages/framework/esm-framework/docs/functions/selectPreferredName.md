...
Defined in: [packages/framework/esm-utils/src/patient-helpers.ts:60](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/patient-helpers.ts#L60)
