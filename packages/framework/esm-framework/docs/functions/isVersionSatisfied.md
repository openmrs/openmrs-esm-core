...
Defined in: [packages/framework/esm-utils/src/version.ts:31](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/version.ts#L31)
