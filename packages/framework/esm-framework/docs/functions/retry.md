...
Defined in: [packages/framework/esm-utils/src/retry.ts:40](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/retry.ts#L40)
