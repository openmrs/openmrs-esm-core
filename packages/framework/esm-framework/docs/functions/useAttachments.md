...
Defined in: [packages/framework/esm-react-utils/src/useAttachments.ts:32](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useAttachments.ts#L32)
