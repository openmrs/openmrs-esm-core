...
Defined in: [packages/framework/esm-react-utils/src/useStore.ts:96](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useStore.ts#L96)
