...
Defined in: [packages/framework/esm-error-handling/src/index.ts:70](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-error-handling/src/index.ts#L70)
