...
Defined in: [packages/framework/esm-styleguide/src/workspaces/workspaces.ts:448](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/workspaces/workspaces.ts#L448)
