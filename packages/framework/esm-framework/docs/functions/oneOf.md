...
Defined in: [packages/framework/esm-config/src/validators/validators.ts:62](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-config/src/validators/validators.ts#L62)
