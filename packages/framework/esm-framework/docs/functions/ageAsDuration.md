...
Defined in: [packages/framework/esm-utils/src/age-helpers.ts:22](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/age-helpers.ts#L22)
