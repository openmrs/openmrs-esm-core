...
Defined in: [packages/framework/esm-offline/src/sync.ts:293](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L293)
