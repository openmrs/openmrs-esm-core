...
Defined in: [packages/framework/esm-utils/src/storage.ts:11](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/storage.ts#L11)
