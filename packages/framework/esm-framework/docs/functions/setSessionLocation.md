...
Defined in: [packages/framework/esm-api/src/current-user.ts:351](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L351)
