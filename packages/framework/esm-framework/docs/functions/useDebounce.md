...
Defined in: [packages/framework/esm-react-utils/src/useDebounce.ts:32](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useDebounce.ts#L32)
