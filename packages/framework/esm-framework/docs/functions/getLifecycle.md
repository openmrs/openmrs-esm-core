...
Defined in: [packages/framework/esm-react-utils/src/getLifecycle.ts:26](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/getLifecycle.ts#L26)
