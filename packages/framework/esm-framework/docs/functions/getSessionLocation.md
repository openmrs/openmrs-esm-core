...
Defined in: [packages/framework/esm-api/src/current-user.ts:325](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L325)
