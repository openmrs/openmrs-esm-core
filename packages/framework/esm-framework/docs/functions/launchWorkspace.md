...
Defined in: [packages/framework/esm-styleguide/src/workspaces/workspaces.ts:305](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/workspaces/workspaces.ts#L305)
