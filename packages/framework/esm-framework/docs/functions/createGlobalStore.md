...
Defined in: [packages/framework/esm-state/src/state.ts:35](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-state/src/state.ts#L35)
