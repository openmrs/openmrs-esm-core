...
Defined in: [packages/framework/esm-offline/src/sync.ts:330](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L330)
