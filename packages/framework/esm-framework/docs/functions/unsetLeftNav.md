...
Defined in: [packages/framework/esm-extensions/src/left-nav.ts:49](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/left-nav.ts#L49)
