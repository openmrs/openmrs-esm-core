...
Defined in: [packages/framework/esm-offline/src/sync.ts:261](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L261)
