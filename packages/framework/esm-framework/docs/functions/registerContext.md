...
Defined in: [packages/framework/esm-context/src/context.ts:29](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-context/src/context.ts#L29)
