...
Defined in: [packages/framework/esm-react-utils/src/useBodyScrollLock.ts:22](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useBodyScrollLock.ts#L22)
