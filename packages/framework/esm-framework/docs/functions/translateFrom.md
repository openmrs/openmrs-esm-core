...
Defined in: [packages/framework/esm-translations/src/index.ts:40](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-translations/src/index.ts#L40)
