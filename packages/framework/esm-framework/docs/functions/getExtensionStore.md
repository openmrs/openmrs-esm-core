...
Defined in: [packages/framework/esm-extensions/src/store.ts:125](https://github.com/UjjawalPrabhat/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/store.ts#L125)
