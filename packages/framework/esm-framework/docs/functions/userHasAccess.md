...
Defined in: [packages/framework/esm-api/src/current-user.ts:255](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L255)
