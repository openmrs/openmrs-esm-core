...
Defined in: [packages/framework/esm-expression-evaluator/src/extractor.ts:47](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-expression-evaluator/src/extractor.ts#L47)
