...
Defined in: [packages/framework/esm-offline/src/mode.ts:45](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/mode.ts#L45)
