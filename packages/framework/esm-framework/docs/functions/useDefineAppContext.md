...
Defined in: [packages/framework/esm-react-utils/src/useDefineAppContext.ts:43](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useDefineAppContext.ts#L43)
