...
Defined in: [packages/framework/esm-dynamic-loading/src/dynamic-loading.ts:38](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-dynamic-loading/src/dynamic-loading.ts#L38)
