...
Defined in: [packages/framework/esm-emr-api/src/current-patient.ts:44](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/current-patient.ts#L44)
