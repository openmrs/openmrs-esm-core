...
Defined in: [packages/framework/esm-config/src/validators/validators.ts:23](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-config/src/validators/validators.ts#L23)
