...
Defined in: [packages/framework/esm-utils/src/shallowEqual.ts:13](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/shallowEqual.ts#L13)
