...
Defined in: [packages/framework/esm-react-utils/src/usePrimaryIdentifierResource.ts:21](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/usePrimaryIdentifierResource.ts#L21)
