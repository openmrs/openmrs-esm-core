...
Defined in: [packages/framework/esm-styleguide/src/numeric-observation/use-concept-reference-range.ts:31](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/numeric-observation/use-concept-reference-range.ts#L31)
