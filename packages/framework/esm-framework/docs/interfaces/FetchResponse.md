...
[packages/framework/esm-api/src/types/fetch.ts:4](https://github.com/jona42-ui/openmrs-esm-core/blob/main/packages/framework/esm-api/src/types/fetch.ts#L4)
