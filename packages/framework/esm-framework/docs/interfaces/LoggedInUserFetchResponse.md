...
[packages/framework/esm-api/src/types/fetch.ts:8](https://github.com/its-kios09/openmrs-esm-core/blob/main/packages/framework/esm-api/src/types/fetch.ts#L8)
