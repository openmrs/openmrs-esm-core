...
Defined in: [packages/framework/esm-api/src/types/user-resource.ts:70](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-api/src/types/user-resource.ts#L70)
