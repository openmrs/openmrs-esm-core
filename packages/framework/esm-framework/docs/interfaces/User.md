...
Defined in: [packages/framework/esm-api/src/types/user-resource.ts:69](https://github.com/openmrs/openmrs-esm-core/blob/main/packages/framework/esm-api/src/types/user-resource.ts#L69)
