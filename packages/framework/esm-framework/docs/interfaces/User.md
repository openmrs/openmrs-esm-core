...
Defined in: [packages/framework/esm-api/src/types/user-resource.ts:68](https://github.com/UjjawalPrabhat/openmrs-esm-core/blob/main/packages/framework/esm-api/src/types/user-resource.ts#L68)
