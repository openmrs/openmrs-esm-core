...
[packages/framework/esm-api/src/types/fhir-resource.ts:2](https://github.com/its-kios09/openmrs-esm-core/blob/main/packages/framework/esm-api/src/types/fhir-resource.ts#L2)
