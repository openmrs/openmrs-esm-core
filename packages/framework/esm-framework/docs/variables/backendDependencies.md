...
Defined in: [packages/framework/esm-api/src/openmrs-backend-dependencies.ts:6](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-api/src/openmrs-backend-dependencies.ts#L6)
