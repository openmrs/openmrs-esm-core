...
Defined in: [packages/framework/esm-react-utils/src/getLifecycle.ts:84](https://github.com/sarvani-701/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/getLifecycle.ts#L84)
