...
Defined in: [packages/framework/esm-react-utils/src/getLifecycle.ts:84](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/getLifecycle.ts#L84)
