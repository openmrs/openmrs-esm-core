...
Defined in: [packages/framework/esm-config/src/validators/validators.ts:69](https://github.com/DushmanthaHerath1/openmrs-esm-core/blob/main/packages/framework/esm-config/src/validators/validators.ts#L69)
