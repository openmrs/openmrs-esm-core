...
Defined in: [packages/framework/esm-utils/src/dates/date-util.ts:493](https://github.com/NitinKumar1-1/openmrs-esm-core/blob/main/packages/framework/esm-utils/src/dates/date-util.ts#L493)
