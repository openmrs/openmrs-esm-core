...
const Login: React.FC = () => {
  ...
  if (!loginProvider || loginProvider.type === 'basic') {
    // Build custom card styles from config
    ...
    // Build custom button styles from config
    ...
    // Determine container class based on layout and columnPosition
    // Apply positioning for both default and split-screen layouts
