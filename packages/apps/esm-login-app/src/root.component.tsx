...
import { MotherIcon, PenIcon , closeWorkspaceGroup2, launchWorkspace2, launchWorkspaceGroup2 } from '@openmrs/esm-framework';
  ...
  return (
    <div>
      ...
      <p>
        ...
        <ul>
          <li>
            The workspace action menu is associated with a workspace group, and is only shown when a workspace group is
            opened.
          </li>
          <li></li>
        </ul>
