...
import styles from './choose-location.scss';
import { useDefaultLocation, useLocationCount } from './choose-location.resource';
...
const ChooseLocation: React.FC<ChooseLocationProps> = ({ hideWelcomeMessage, currentLocationUuid }) => {
