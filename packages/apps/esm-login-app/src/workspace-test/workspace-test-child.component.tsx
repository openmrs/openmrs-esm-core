  ...
  return (
    <Workspace2 title={'hello'}>
      <div style={{padding: '20px', backgroundColor: "lightblue"}}>
        ...
        <div><button onClick={() => closeWorkspace({closeWindow: true})}>Close All Workspaces in Window</button></div>
        <div><button onClick={() => closeWorkspace({closeWindow: true, discardUnsavedChanges: true})}>Close All Workspaces in Window and Discard unsaved changes</button></div>
      </div>
    </Workspace2>
  );
}
